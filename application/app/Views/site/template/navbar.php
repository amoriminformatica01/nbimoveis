<nav class="navbar navbar-expand-lg navbar-light" style="background-color: silver">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="<?= base_url('img/site/nb-logo.png') ?>" height="60px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/imoveis"><i class="fa-solid fa-building"></i> Imoveis</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/sobre"><i class="fa fa-info"></i> Sobre</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/contato"><i class="fa fa-address-book"></i> Contato</a>
                </li>
