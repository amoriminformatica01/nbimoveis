...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            ...
            <form action="<?= base_url('/tipo/update/'.$tipos['id']) ?>" method="POST" enctype="multipart/form-data">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="">Tipo</label>
                                <input class="form-control border border-2 border-success" type="text" name="tipo" value="<?=$tipos['tipo']?>" id="tipo" required>
                            </div>
                        </div>
                    </div>
